def demo():
    ...
    list_assgn = [spam, ham] = ['yum', 'YUM']  # List assignment (positional)
    print('list assignment - {}, spam - {}, ham - {}'.format(list_assgn, spam, ham))
    ...
    set_attr = [a, b, c] = {1, 2, 3}  # a = 1 and so on, note that set_attr is assigned the set '{1, 2, 3}'
    print('set = ', set_attr)
    print('a = {}, b = {}, c = {}'.format(a, b, c))
